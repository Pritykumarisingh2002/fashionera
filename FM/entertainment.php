...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar">
            ...
            <a href="index.php#price">Price</a>
    ...
    <form class="Event Manager" action="JD.php">
        <section class="gallery" id="gallery">
            <h1 class="heading">our <span>gallery</span></h1>
            <div class="box-container">
                <div class="box">
                    <img src="images/eventmanager.jpg" alt="" />
                    <h3 class="title">Event Manager</h3>
                    <div class="icons">
    ...
    <form class="Dress Designer" action="JD.php">
        <div class="box">
            <img src="images/dress.jpg" alt="" />
            <h3 class="title">Dress Designer</h3>
            <div class="icons">
                <button type="submit" class="btn">Apply Now</button>
            </div>
        </div>
    ...
    <form class="photographer" action="JD.php">
        <div class="box">
            <video width="350" height="240" controls>
                <source src="https://in.video.search.yahoo.com/search/video;_ylt=AwrKANRnXUBncQIArjq7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Nj?type=E210IN885G91852&p=fashion+walk+shows&fr=mcafee&turl=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOVP.xePix94ohYecywxLbFwxtAHgFo%26pid%3DApi%26w%3D296%26h%3D156%26c%3D7%26p%3D0&rurl=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DOwSt0Quygno&tit=TOP+10+MODELS+Best+Runway+Walks+2020+-+Fashion+Channel&pos=01&vid=11b452a21310b00c0075492001c4d61a&sigr=i8NF1fYsmTPg&sigt=drwHkFiM60z6&sigi=2phUnHaQhpw_" type="video/mp4">
            </video>
            <h3 class="title">Bangalore Fashion Walk</h3>
            <div class="icons">
                <a href="https://in.video.search.yahoo.com/search/video;_ylt=AwrKANRnXUBncQIArjq7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Nj?type=E210IN885G91852&p=fashion+walk+shows&fr=mcafee&turl=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOVP.xePix94ohYecywxLbFwxtAHgFo%26pid%3DApi%26w%3D296%26h%3D156%26c%3D7%26p%3D0&rurl=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DOwSt0Quygno&tit=TOP+10+MODELS+Best+Runway+Walks+2020+-+Fashion+Channel&pos=01&vid=11b452a21310b00c0075492001c4d61a&sigr=i8NF1fYsmTPg&sigt=drwHkFiM60z6&sigi=2phUnHaQhpw_" class="fas fa-eye"></a>
            </div>
        </div>
    </form>

    <form class="makeup" action="JD.php">
        <div class="box">
    ...
    <form class="manager" action="JD.php">
        <div class="box">
            <img src="images/senior-manager.jpg" alt="" />
    ...
    <form class="planner" action="JD.php">
        <div class="box">
    ...
    <form class="trainer" action="JD.php">
        <div class="box">
    ...
    <form class="Producer" action="JD.php">
        <div class="box">
            <img src="images/producer.jpg" alt="" />
            <h3 class="title">Fashion Show Producer</h3>
            <div class="icons">
                <button type="submit" class="btn">Apply Now</button>
            </div>
        </div>
    ...
    <form class="fresher" action="JD.php">
        <div class="box">
            <img src="images/gallery9.jpg" alt="" />
            <h3 class="title">Fresher</h3>
            <div class="icons">
                <button type="submit" class="btn">Apply Now</button>
            </div>
        </div>
    ...
    <section class="contact" id="contact">
        ...
        <form action="https://formsubmit.co/pritykumarisingh0018@gmail.com" method="POST">
            <div class="inputBox">
            ...
            <input type="hidden" name="_next" value="https://htmlburger.com/blog/wp-content/uploads/2023/11/thank-you-for-reaching-page.jpg" style="width: fit-content">
    ...
    <section class="footer">
        <div class="box-container">
            ...
            <div class="box">
                ...
                <a href="index.php#service"> <i class="fas fa-arrow-right"></i> Service </a>
                <a href="index.php#about"> <i class="fas fa-arrow-right"></i> About </a>
                <a href="index.php#gallery"> <i class="fas fa-arrow-right"></i> Gallery </a>
                <a href="index.php#price"> <i class="fas fa-arrow-right"></i> Price </a>
                <a href="index.php#careers"> <i class="fas fa-arrow-right"></i> Career </a>
                <a href="index.php#review"> <i class="fas fa-arrow-right"></i> Reivew </a>
                <a href="index.php#contact"> <i class="fas fa-arrow-right"></i> Contact </a>
            </div>
